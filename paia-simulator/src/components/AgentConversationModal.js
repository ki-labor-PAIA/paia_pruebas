            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <span>📨</span>
                            <span>{messages.length} mensajes intercambiados</span>
                        </div>
                        {isActive && (
                            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                <span>⚡</span>
                ...
                <div style={{
                    ...
                    {messages.length === 0 ? (
                        <div style={{
                            ...
                            <div style={{ fontSize: '14px' }}>Esperando que los agentes comiencen a comunicarse...</div>
                        </div>
                    ) : (
                ...
                <div style={{
                    ...
                    <div style={{ fontSize: '12px', color: '#6B7280' }}>
                        Los agentes están negociando automáticamente
                    </div>
                    <button
                        onClick={onClose}
                        style={{
